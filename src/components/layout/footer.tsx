...
import hackforceLogo from '@/assets/hackforce-logo.png';
        ...
        <GlassCard className="p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <img src={hackforceLogo} alt="HackForce" className="w-8 h-8" />
              ...
              <p className="text-muted-foreground mb-6 max-w-sm">
                Where skills meet challenges. Join the ultimate platform for hackathons, 
                team formation, and competitive coding.
              </p>
          ...
          <div className="mt-8 pt-8 border-t border-glass-border flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted-foreground text-sm">
              © 2024 HackForce. All rights reserved.
            </p>
