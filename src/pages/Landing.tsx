...
import { ArrowRight, Users, Zap, Target, Trophy, Star, Quote } from 'lucide-react';
...
const features = [
  {
    ...
    description: 'Get matched with teammates based on complementary skills and experience levels.'
  },
  {
    icon: Zap,
    title: 'Instant Lobbies',
    description: 'Join hackathon lobbies instantly and start collaborating with like-minded developers.'
  },
  {
    icon: Target,
    title: 'Problem Assignment',
    description: 'Receive tailored challenges that match your team\'s collective skill set.'
  },
  {
    icon: Trophy,
    title: 'Competitive Ranking',
    description: 'Track your progress and compete on leaderboards across multiple hackathons.'
  }
];

const testimonials = [
  {
    quote: "HackForce helped me find the perfect team for my first hackathon. The skill matching is incredible!",
    author: "Sarah Chen",
      ...
      <section className="relative pt-12 pb-20 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div 
              className="absolute inset-0 -z-10 opacity-30 rounded-3xl"
              style={{
            ...
            <GlassCard className="mx-auto max-w-4xl p-12 relative">
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
              ...
              <h1 className="font-bold text-5xl md:text-7xl lg:text-8xl mb-6 text-foreground">
                HackMate
              </h1>
              ...
              >
                Join the ultimate platform for skill-based hackathons, intelligent team formation, 
                and competitive coding challenges. Connect with developers worldwide and build the future together.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Everything you need to excel in hackathons and collaborative coding challenges
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <GlassCard variant="interactive" className="p-8 h-full text-center group">
          ...
          <GlassCard variant="glow" className="p-12">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Join HackForce today and connect with the most talented developers in the world. 
