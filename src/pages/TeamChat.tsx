...
const hackathonData = {
    ...
    description: 'Build an AI-powered collaboration tool that revolutionizes how teams work together in virtual environments. Focus on creating innovative solutions that enhance productivity and communication.',
    startDate: '2025-09-10T09:00:00Z',
    endDate: '2025-09-12T18:00:00Z',
    submissionDeadline: '2025-09-12T17:00:00Z',
    maxTeamSize: 4,
    ...
    submissionFormat: 'GitHub repository + Live demo + Presentation slides',
    tags: ['AI', 'Collaboration', 'Innovation', 'SaaS'],
    timeLeft: '23:59:51'
};
...
export default function TeamChat() {
    ...
    const [timeLeft, setTimeLeft] = useState(hackathonData.timeLeft);
    ...
    const getStatusIcon = (status, isOwnMessage) => {
