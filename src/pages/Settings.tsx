...
export default function Settings() {
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-6 mb-8">
        <div className="relative">
          ...
          <Button variant="glass" size="sm" className="absolute -bottom-2 -right-2">
            <Upload className="w-4 h-4" />
          </Button>
        </div>
        <div>
          <h3 className="font-orbitron font-bold text-xl text-foreground mb-2">Profile Picture</h3>
          <p className="text-muted-foreground text-sm mb-4">
            Upload a new profile picture or remove the current one
          </p>
          <div className="flex gap-2">
            <Button variant="neon" size="sm">Upload New</Button>
  ...
  const renderNotificationsTab = () => (
    <div className="space-y-6">
      {Object.entries(formData.notifications).map(([key, value]) => (
        <div key={key} className="flex items-center justify-between p-4 rounded-lg glass">
          <div>
            <h4 className="font-medium text-foreground capitalize">
              {key.replace(/([A-Z])/g, ' $1').trim()}
            </h4>
            <p className="text-sm text-muted-foreground">
              {key === 'hackathonInvites' && 'Receive notifications when invited to hackathons'}
              {key === 'teamFormation' && 'Get notified when teams are being formed'}
              {key === 'projectUpdates' && 'Updates on your project progress and milestones'}
              {key === 'achievements' && 'Notifications for new achievements and badges'}
  ...
  const renderPrivacyTab = () => (
    <div className="space-y-6">
      <GlassCard className="p-6">
        <h3 className="font-orbitron font-bold text-lg text-foreground mb-4">Privacy Settings</h3>
            ...
            <div key={key} className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ...
                  {key === 'showEmail' && 'Display email address on your public profile'}
                  {key === 'showPhone' && 'Display phone number on your public profile'}
                  {key === 'showStats' && 'Show your statistics and achievements publicly'}
      ...
      <GlassCard className="p-6">
        <h3 className="font-orbitron font-bold text-lg text-foreground mb-4">Security</h3>
        <div className="space-y-4">
          <div className="space-y-2">
  ...
  const renderAppearanceTab = () => (
    <div className="space-y-6">
      <GlassCard className="p-6">
        <h3 className="font-orbitron font-bold text-lg text-foreground mb-4">Theme Settings</h3>
      ...
      <GlassCard className="p-6">
        <h3 className="font-orbitron font-bold text-lg text-foreground mb-4">Display Preferences</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
  ...
  const renderSocialTab = () => (
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-lg bg-primary/10 border border-primary/20">
        <h4 className="font-medium text-foreground mb-2">Why connect social accounts?</h4>
      ...
      <div className="relative max-w-7xl mx-auto p-6">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Customize your HackForce experience and manage your account preferences
          </p>
        </motion.div>
